    ...
    "barbershop": [
        {
            ...
            "price": 45.00,
            "stock": 50,
            "description": "Pomada de alta fixação com acabamento fosco.",
        },
        {
        ...
        {
            "name": "Shampoo Fresh Mentol",
            "price": 25.00,
            "stock": 40,
            "description": "Shampoo refrescante para uso diário.",
        },
        {
            "name": "Cera de Bigode",
            "price": 20.00,
            "stock": 25,
            "description": "Cera modeladora para bigodes rebeldes.",
        },
        {
            "name": "Kit Barbear Clássico",
            "price": 120.00,
            "stock": 10,
            "description": "Kit com pincel, tigela e sabão de barbear.",
        },
    ],
    "salon": [
        {
            "name": "Máscara de Hidratação 1kg",
            "price": 85.00,
            "stock": 20,
        ...
        },
        {
            ...
            "price": 40.00,
            "stock": 35,
            "description": "Finalizador que elimina o frizz e as pontas duplas.",
        },
        {
            "name": "Shampoo Pós-Química",
            "price": 30.00,
            "stock": 50,
            "description": "Manutenção ideal para cabelos coloridos ou com progressiva.",
        },
        {
            "name": "Leave-in Termoativado",
            "price": 45.00,
            "stock": 30,
            "description": "Proteção térmica para uso com secador e chapinha.",
        },
        {
            "name": "Kit Manicure Completo",
            "price": 60.00,
            "stock": 15,
            "description": "Conjunto de esmaltes e alicates profissionais.",
        },
    ],
    "spa": [
        {
            ...
            "price": 55.00,
            "stock": 25,
            "description": "Óleo essencial para massagens corporais.",
        },
        {
            "name": "Sais de Banho Aromáticos",
            "price": 35.00,
            "stock": 40,
            "description": "Sais para imersão e relaxamento.",
        },
        {
            "name": "Creme Facial Anti-Idade",
            "price": 95.00,
            "stock": 15,
            "description": "Creme nutritivo com ácido hialurônico.",
        },
        {
            "name": "Esfoliante Corporal Café",
            "price": 45.00,
            "stock": 30,
            "description": "Esfoliante natural para renovação da pele.",
        },
        {
            "name": "Vela Aromática Lavanda",
            "price": 28.00,
            "stock": 50,
            "description": "Vela relaxante com aroma suave de lavanda.",
        },
    ],
}
