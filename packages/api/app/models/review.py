...
class Review(BaseModel):
    ...
    __table_args__ = (
        Index("idx_reviews_establishment_rating", "establishment_id", "rating"),
    )
...
class Favorite(BaseModel):
    ...
    __table_args__ = (
        Index("idx_favorites_unique", "user_id", "establishment_id", unique=True),
    )
...
class FavoriteStaff(BaseModel):
    ...
    __table_args__ = (
        Index("idx_favorite_staff_unique", "user_id", "staff_id", unique=True),
    )
