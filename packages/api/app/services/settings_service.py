...
class SettingsService:
    ...
    async def seed_defaults(self) -> int:
        ...
        defaults = [
            ...
            (
                SettingsKeys.MERCADOPAGO_CLIENT_ID,
                "",
                "Mercado Pago Client ID (OAuth marketplace)",
                False,
                "payments",
            ),
            (
                SettingsKeys.MERCADOPAGO_CLIENT_SECRET,
                "",
                "Mercado Pago Client Secret (OAuth marketplace)",
                True,
                "payments",
            ),
            (
                SettingsKeys.MERCADOPAGO_OAUTH_REDIRECT_URI,
                "https://api.dunnaa.com.br/api/v1/mercadopago/oauth/callback",
            ...
            (
                ...
                "false",
                "Ativar envio via WhatsApp (OTP, agendamentos, fila)",
                False,
                "whatsapp",
            ),
            (
                ...
                "bridge",
                "Provedor: bridge (QR), meta (Cloud API) ou twilio",
                False,
                "whatsapp",
            ),
            (
